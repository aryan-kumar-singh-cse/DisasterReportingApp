...
export default function App() {
  ...
  const [viewMode, setViewMode] = useState('citizen'); // 'citizen' or 'responder'
    ...
    <div className="flex flex-col h-screen w-screen bg-zinc-950 text-zinc-100 overflow-hidden font-sans select-none">
      ...
      <header className="h-14 bg-zinc-950 border-b border-zinc-800 px-4 flex items-center justify-between z-30 flex-shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-cyan-600 to-blue-600 flex items-center justify-center shadow-lg shadow-cyan-600/30">
            <span className="font-black text-white text-base">2T</span>
          </div>
          <div>
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-base tracking-tight text-white">TwoTruths</span>
            ...
            <p className="text-[10px] text-zinc-400 hidden sm:block">
              The Disaster Intelligence Map That Shows You What It Doesn't Know
            </p>
          </div>
        </div>
      ...
      {viewMode === 'citizen' ? (
        <div className="flex-1 flex flex-col min-h-0 relative">
          ...
          <div className="flex-1 flex flex-col md:flex-row min-h-0 relative">
            ...
            {selectedReport && (
              <div className="w-full md:w-[480px] lg:w-[520px] h-[50vh] md:h-full z-20 flex-shrink-0 shadow-2xl">
                <ReportCard
